...
class Sortirovki_pypy:
    ...
    def list_almost(n):
        ...
        if numSort == n:
            return Sortirovki_pypy.list_normal(n)[numSort-1:] + Sortirovki_pypy.list_normal(n)[:numSort-1]
        else:
            return Sortirovki_pypy.list_normal(n)[numSort-1:] + Sortirovki_pypy.list_normal(n)[:numSort]
